...
import com.cloudmersive.client.invoker.auth.Authentication;
import com.cloudmersive.client.invoker.auth.ApiKeyAuth;
import com.cloudmersive.client.invoker.auth.HttpBasicAuth;
import com.cloudmersive.client.invoker.request.GetRequest;
import com.cloudmersive.client.invoker.request.PostRequest;
import com.cloudmersive.client.invoker.request.PutRequest;
import com.cloudmersive.client.invoker.request.DeleteRequest;
import com.cloudmersive.client.invoker.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    setUserAgent("Swagger-Codegen/2.0.3/android");

    // Setup authentications (key: authentication name, value: authentication).
    INSTANCE.authentications = new HashMap<String, Authentication>();
    INSTANCE.authentications.put("Apikey", new ApiKeyAuth("header", "Apikey"));
